...
document.write('<style>a{color:#24292e;cursor:pointer;text-decoration:none}
        ...
        @media only screen and (max-width:480px){
            ...
            .size, .updated_at{display:none}.nexmoe-item {background-color: rgba(255,255,255,.8)!important;background-repeat:no-repeat;background-size:cover;background-attachment:fixed;background-image:url("https://cdn.jsdelivr.net/gh/iMacyhs/ShareHub@master/02100de48cd5e98fdd2b9cabe2c12a95.jpg")}}</style>');
