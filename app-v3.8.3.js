...
document.write('<style>.mdui-appbar .mdui-toolbar{height:56px;font-size:1pc}.mdui-toolbar{mdui-toolbar-color: rgba(255,255,255,.8)!important;}.mdui-toolbar>i{opacity:.5}.mdui-toolbar>i{padding:0}.mdui-toolbar>a:hover,a.active,a.mdui-typo-headline{opacity:1}.mdui-container{max-width:980px}.mdui-list-item{transition:none}.mdui-list>.th{background-color:initial}.mdui-list-item>a{width:100%;line-height:3pc}.mdui-list-item{margin:2px 0;padding:0}.mdui-toolbar>a:last-child{opacity:1}@media screen and (max-width:980px){.mdui-list-item .mdui-text-right{display:none}.mdui-container{width:100%!important;margin:0}.nexmoe-item {background-color: rgba(255,255,255,.8)!important;}</style><style>body {background-image: url("https://cdn.jsdelivr.net/gh/iMacyhs/ShareHub@master/02100de48cd5e98fdd2b9cabe2c12a95.jpg") !important;background-position: center bottom !important;background-size: cover !important;background-attachment: fixed !important;background-repeat: no-repeat !important;}</style>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src="https://cdn.jsdelivr.net/gh/iMacyhs/ShareHub@master/avatar.jpg"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
